...
class BeerBottomSheetFragment(private val beer: Beer) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val locationAndManfTextView =
            root.findViewById<TextView>(R.id.bottom_sheet_location_and_manf_textview)
        val descriptionTextView =
            root.findViewById<TextView>(R.id.bottom_sheet_description_textview)
